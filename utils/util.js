...
util.request = function (option) {
	...
	option.showLoading = option.showLoading==false? false : true;
        ...
        success: function (session) {
            ...
            wx.getUserInfo({
              success: function (wxInfo) {      
                wx.request({
                  url: config.requestUrl + 'wx/login/userinfo',
                  data: {
                    nickName: wxInfo.userInfo.nickName,
                    headUrl: wxInfo.userInfo.avatarUrl,
                    gender: wxInfo.userInfo.getder,
                    city: wxInfo.userInfo.city,
                    sex:wxInfo.userInfo.gender,
...
//新接口
util.saveUserInfo = function (user, cb) {
  var userInfo = {
    'openid': '',
    'wxInfo': '',
  };
